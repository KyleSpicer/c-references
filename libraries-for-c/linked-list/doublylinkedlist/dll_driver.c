// ------------------------------------------------------------------------------
//Lesson 3 Exercise:doubly linked list
//
...
#define POINT_TOTAL 23

static const int point[TEST_TOTAL] = {1, 2, 2, 2, 2, 2, 2, 2, 1, 2, 1, 4};
...
int main(void)
{
	...
	//Test.
	puts(section);
	node = get_node_at(llist, 5);

	//Verify position of new node.
	printf("Is the search node in the correct position?\n");
	verify_node(llist, node, 5, 5);
	puts(footer);
